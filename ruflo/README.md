...
| **[MetaHarness Guide](https://github.com/ruvnet/ruflo/blob/main/docs/metaharness-user-guide.md)** | Deep guide to the 10 `ruflo metaharness *` subcommands + 9 MCP tools + genome similarity + `ruflo eject`. The *audit-the-harness* doc. |
